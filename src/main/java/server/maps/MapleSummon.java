...
public class MapleSummon extends AnimatedMapleMapObject {
	...
	public MapleSummon(final MapleCharacter owner, final int sourceid, final int level, final Point pos,
		...
		if (!isPuppet()) { // Safe up 12 bytes of data, since puppet doesn't
							// attack.
	...
	public final boolean isMultiAttack() {
		return skill == 35111002 || skill == 36121002 || skill == 36121013 || skill == 35121003
				|| (!isGaviota() && skill != 33101008 && skill < 35000000) || skill == 35111009 || skill == 35111010
				|| skill == 35111001 || skill == 42111003;
	}
	...
	public final int getSummonType() {
		if (isAngel()) {
			return 2;
		} else if ((skill != 33111003 && skill != 3120012 && skill != 3220012 && isPuppet()) || skill == 33101008
				|| skill == 35111002) {
			return 0;
		}
		switch (skill) {
