...
public class LoginWorker {
	...
	public static void registerClient(final MapleClient c) {
		...
		if (c.finishLogin() == 0) {
			...
			// + 1);
			// c.getSession().write(LoginPacket.getCharList(c.getSecondPassword()
			// != null, c.loadCharacters(0), c.getCharacterSlots()));
			// end temp fix
