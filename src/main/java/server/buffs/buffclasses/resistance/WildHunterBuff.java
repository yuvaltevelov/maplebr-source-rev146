...
public class WildHunterBuff extends AbstractBuffClass {
	...
	public void handleBuff(MapleStatEffect eff, int skill) {
		...
		case 33101005:// Call of the Wild
			...
			// eff.statups.put(MapleBuffStat.SATELLITESAFE_ABSORB,
			// eff.info.get(MapleStatInfo.lt));
			// eff.statups.put(MapleBuffStat.SOULARROW,
			// eff.info.get(MapleStatInfo.rb));
			break;
		...
		case 33121004: // Sharp Eyes
			eff.statups.put(MapleBuffStat.SHARP_EYES,
