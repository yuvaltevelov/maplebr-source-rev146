...
public class MobPacket {
	...
	public static byte[] SmartMobnotice(int mobId, int type, int number, String message, byte color) {
		...
		mplew.writeInt(mobId);
		mplew.writeInt(type);// 1:attack, 2:skill, 3:change controller,
								// 5:mobzone?
	...
	public static byte[] moveMonster(boolean useskill, int skill, int skill1, int skill2, int skill3, int skill4,
			int oid, Point startPos, List<LifeMovementFragment> moves) {
	...
	/*
	 * public static byte[] moveMonster(boolean useskill, int skill, int unk,
	 * int oid, Point startPos, List<LifeMovementFragment> moves) { return
	 * moveMonster(useskill, skill, unk, oid, startPos, moves, null, null); }
	 * 
	 * /* public static byte[] moveMonster(boolean useskill, int skill, int unk,
	 * int oid, Point startPos, List<LifeMovementFragment> moves, List<Integer>
	 * unk2, List<Pair<Integer, Integer>> unk3) { MaplePacketLittleEndianWriter
	 * mplew = new MaplePacketLittleEndianWriter();
	 * 
	 * mplew.writeShort(SendPacketOpcode.MOVE_MONSTER.getValue());
	 * mplew.writeInt(oid); mplew.write(useskill ? 1 : 0); mplew.write(skill);
	 * mplew.writeInt(unk); mplew.write(unk3 == null ? 0 : unk3.size()); if
	 * (unk3 != null) { for (Pair i : unk3) { mplew.writeShort(((Integer)
	 * i.left)); mplew.writeShort(((Integer) i.right)); } } mplew.write(unk2 ==
	 * null ? 0 : unk2.size()); if (unk2 != null) { for (Integer i : unk2) {
	 * mplew.writeShort(i); } }
	 * 
	 * mplew.writeInt(0); mplew.writePos(startPos); mplew.writeInt(0);
	 * 
	...
	public static void addMonsterInformation(MaplePacketLittleEndianWriter mplew, MapleMonster life, boolean newSpawn,
			boolean summon, byte spawnType, int link) {
		mplew.writePos(life.getTruePosition());
		mplew.write(life.getStance());
		mplew.writeShort(0);
		mplew.writeShort(life.getFh());
