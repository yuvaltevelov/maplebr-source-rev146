	...
	public static void Initialize() throws FileNotFoundException {
		try {
			...
			if (f.exists()) {
				...
				System.out.println(
						"Unable to load GMS Keys, because there were no cached keys stored and I failed retrieving them from the webserver! D:\r\nYou might want to check your internet connection and see if you can access http://direct.craftnet.nl/ directly.");
				System.exit(1);
			}
		}

		MapleStoryGlobalKeys.put((short) 118, new byte[] { 0x5A, // Full key's
																	// lost
				0x22, (byte) 0xFB, (byte) 0xD1, (byte) 0x8F, (byte) 0x93, (byte) 0xCD, (byte) 0xE6, });
	}
