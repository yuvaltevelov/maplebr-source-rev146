...
public class AngelicBusterBuff extends AbstractBuffClass {
	...
	public AngelicBusterBuff() {
		buffs = new int[] { 60011219, // Terms and Conditions
	...
	public void handleBuff(MapleStatEffect eff, int skill) {
		...
		case 65121053: // Final Contract - TODO
			// eff.statups.put(MapleBuffStat.CRITICAL_RATE,
			// eff.info.get(MapleStatInfo.x));
			// eff.statups.put(MapleBuffStat.STANCE,
			// eff.info.get(MapleStatInfo.y));
			// eff.statups.put(MapleBuffStat.ABNORMAL_STATUS_R,
			// eff.info.get(MapleStatInfo.asrR));
			// eff.statups.put(MapleBuffStat.ELEMENTAL_STATUS_R,
			// eff.info.get(MapleStatInfo.terR));
			break;
		case 65121054: // Pretty Exaltation - TODO
			// eff.statups.put(MapleBuffStat.RECHARGE,
			// eff.info.get(MapleStatInfo.x));
			break;
		default:
