...
public class HiredMerchantSave {
	...
	private static class HiredMerchantSaveRunnable implements Runnable {
		...
		private final ArrayBlockingQueue<HiredMerchant> Queue = new ArrayBlockingQueue<>(500); // 500
																								// Start
																								// Capacity
																								// (Should
																								// be
		...
		public void run() {
			try {
				...
				System.out.println("[HiredMerchantSave Thread " + ThreadID + "] Shops Saved: " + ShopsSaved
