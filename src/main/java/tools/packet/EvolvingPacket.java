...
public class EvolvingPacket {
	...
	public static byte[] partyCoreInfo(int[] core) {
		MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
		// AF 00 /00 /48 EF 36 00 /D3 FB 36 00 /00 00 00 00 /00 00 00 00/ 00 00
		// 00 00/ 00 00 00 00 /00 00 00 00 /32 F3 36 00 /00 00 00 00 /00 00 00
		// 00
	...
	public static void EvolvingWarpToMapInfo(MaplePacketLittleEndianWriter mplew, MapleCharacter player, MapleMap map,
			int sp) {
