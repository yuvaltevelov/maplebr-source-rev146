...
public class MapleNPC extends AbstractLoadedMapleLife {
	...
	public final boolean hasShop() {
		return getId() == MoonlightRevamp.shopNpc && MoonlightRevamp.MoonlightRevamp ? true
				: getId() == CustomShop.shopNpc && CustomShop.active ? true
						: MapleShopFactory.getInstance().getShopForNPC(getId()) != null;
	}
