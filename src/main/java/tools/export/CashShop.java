		...
		try {
			for (int menu = 1; menu <= 4; menu++) {
				...
				for (int i = 0; i < length; i++) {
					...
					sb.append(
							"`sn`, `itemid`, `flag`, `price`, `discountPrice`, `quantity`, `expire`, `gender`, `likes`) ");
					...
					// sb.append("\r\nINSERT INTO cashshop_menuitems
					// (`category`, `subcategory`, `parent`, `image`, `sn`,
					// `itemid`, `flag`, `price`, `discountPrice`, `quantity`,
					// `expire`, `gender`, `likes`) ");
					// sb.append("VALUES (").append(category).append(",
					// ").append(subcategory).append(", ");
					// sb.append(parent).append(", '").append(image).append("',
					// ").append(sn).append(", ");
					// sb.append(itemid).append(", ").append(flag).append(",
					// ").append(price).append(", ");
					// sb.append(discountPrice).append(",
					// ").append(quantity).append(", ").append(expire);
