...
public class MoonlightRevamp {
	...
	public static final int monsterSpawn = 1; // 2 monsters in one spawn point
												// instead of one
	...
	public static enum MoonlightShop {
		...
		// Example: letter(shopitemid, shopid, itemid, price, position,
		// requiered item, requiered item quantity, rank, how many in a bundle,
		// tab, minimum level to buy, expirates in)
		ITEM_1(1, shopId, 1003151, 0, coin, 30, (byte) 0, 0, 0, 0, 0), ITEM_2(2, shopId, 1050209, 0, coin, 15, (byte) 0,
				0, 0, 0, 0), ITEM_3(3, shopId, 1051255, 0, coin, 15, (byte) 0, 0, 0, 0, 0), ITEM_4(4, shopId, 1102311,
						0, coin, 20, (byte) 0, 0, 0, 0,
						0), ITEM_5(5, shopId, 1142250, 0, coin, 20, (byte) 0, 0, 0, 0, 0), ITEM_6(6, shopId, 2002039, 0,
								coin, 2, (byte) 0, 0, 0, 0,
								0), ITEM_7(7, shopId, 2002040, 0, coin, 2, (byte) 0, 0, 0, 0, 0), ITEM_8(8, shopId,
										2049301, 0, coin, 8, (byte) 0, 0, 0, 0,
										0), ITEM_9(9, shopId, 2049300, 0, coin, 12, (byte) 0, 0, 0, 0, 0), ITEM_10(10,
												shopId, 2049401, 0, coin, 6, (byte) 0, 0, 0, 0, 0), ITEM_11(11, shopId,
														2049400, 0, coin, 8, (byte) 0, 0, 0, 0, 0), ITEM_12(12, shopId,
																2049100, 0, coin, 6, (byte) 0, 0, 0, 0, 0), ITEM_13(13,
																		shopId, 3700015, 0, coin, 5, (byte) 0, 0, 0, 0,
																		0), ITEM_14(14, shopId, 4032041, 0, coin, 5,
																				(byte) 0, 0, 0, 0, 0);
