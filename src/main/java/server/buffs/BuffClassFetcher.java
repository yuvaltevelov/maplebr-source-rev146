...
public class BuffClassFetcher {
	...
	public static final Class<?>[] buffClasses = { WarriorBuff.class, MagicianBuff.class, BowmanBuff.class,
			ThiefBuff.class, PirateBuff.class, DawnWarriorBuff.class, WindArcherBuff.class, MihileBuff.class,
			AranBuff.class, EvanBuff.class, LuminousBuff.class, AngelicBusterBuff.class, XenonBuff.class,
			WildHunterBuff.class, DemonBuff.class, KannaBuff.class, HayatoBuff.class, ZeroBuff.class };
