...
public enum MapleStat {
	...
	INSIGHT(0x1000000), WILL(0x2000000), // int
	...
	BATTLE_POINTS(0x100000000L), ICE_GAGE(0x200000000L), VIRTUE(0x400000000L);
	...
	public static enum Temp {
		...
		STR(0x1), DEX(0x2), INT(0x4), LUK(0x8), WATK(0x10), WDEF(0x20), MATK(0x40), MDEF(0x80), ACC(0x100), AVOID(
				0x200), SPEED(0x400), // byte
				JUMP(0x800), // byte
				UNKNOWN(0x1000); // byte
		private final int i;
