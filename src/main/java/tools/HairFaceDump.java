...
public class HairFaceDump {
	...
	public static void main(String[] args) throws IOException {
		...
		if (maleHair1.isEmpty() || maleHair2.isEmpty() || maleHair3.isEmpty() || femaleHair1.isEmpty()
				|| femaleHair2.isEmpty() || femaleHair3.isEmpty() || maleFace.isEmpty() || femaleFace.isEmpty()) {
		...
		sb.append(createStyler(maleHair1, maleHair2, maleHair3, femaleHair1, femaleHair2, femaleHair3, maleFace,
				femaleFace, hairList, faceList));
	...
	public static String createStyler(List<Integer> maleHair1, List<Integer> maleHair2, List<Integer> maleHair3,
			List<Integer> femaleHair1, List<Integer> femaleHair2, List<Integer> femaleHair3, List<Integer> maleFace,
			List<Integer> femaleFace, List<Integer> hairList, List<Integer> faceList) {
		StringBuilder sb = new StringBuilder();
		addLine(sb, "var v1;");
		addLine(sb, "var v2;");
		addLine(sb, "var v3;");
