...
public class ServerConstants {
	...
	public static String SQL_PORT = "3306", SQL_DATABASE = "Elision", SQL_USER = "Chaos_Mally",
			SQL_PASSWORD = "0910-Chaos-90";
	...
	public static final boolean Old_Maps = false; // example: it will use old
													// maple event's henesys
													// instead of current one
	public static final boolean Use_Localhost = false; // true = packets are
														// logged, false =
														// others can connect to
														// server
	public static final boolean Redirector = true; // false = not using
													// redirector
	...
	public static final byte SHOP_DISCOUNT = 0; // Discount Rate (%) Higher than
												// 100 or lower than 1 means no
												// discount

	// Login Backgrounds
	public static Triple<String, Integer, Boolean>[] backgrounds = new Triple[] { // boolean
																					// for
																					// randomize
			new Triple<>("red3", 0, true), new Triple<>("red2", 0, true), new Triple<>("red1", 0, false) };

	public static enum PlayerGMRank {

		NORMAL('@', 0), INTERN('!', 1), GM('!', 2), SUPERGM('!', 3), ADMIN('!', 4);
