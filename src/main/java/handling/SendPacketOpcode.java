...
public enum SendPacketOpcode implements WritableIntValueHolder {
	...
	// Login
	LOGIN_STATUS((short) 0x00), SEND_LINK((short) 0x01), LOGIN_SECOND((short) 0x02), CHANNEL_SELECTED(
			(short) 0x02), PIC_RESPONSE((short) 0x19), SERVERSTATUS((short) 0x04), GENDER_SET(
					(short) 0x05), PIN_OPERATION((short) 0x06), PIN_ASSIGNED((short) 0x07), ALL_CHARLIST(
							(short) 0x08), SERVERLIST((short) 0x09), CHARLIST((short) 0x0A), SERVER_IP(
									(short) 0x0B), CHAR_NAME_RESPONSE((short) 0x0C), ADD_NEW_CHAR_ENTRY(
											(short) 0x0D), DELETE_CHAR_RESPONSE((short) 0x0E), CHANGE_CHANNEL(
													(short) 0x11), // 10
	...
	EXP_POTION((short) 0x43), REPORT_RESULT((short) 0x4E), TRADE_LIMIT((short) 0x50), UPDATE_GENDER((short) 0x51), // 50
	...
	FAMILY_MESSAGE((short) 0x8E), FAMILY_INVITE((short) 0x999), FAMILY_JUNIOR((short) 0x93), // 90
	SENIOR_MESSAGE((short) 0x94), // 91
	FAMILY((short) 0x95), // 94
	REP_INCREASE((short) 0x96), // 95
	EVOLVING_ACTION((short) 0x98), FAMILY_LOGGEDIN((short) 0x99), // 96
	...
	MAPLE_TV_MSG((short) 0x8D), AVATAR_MEGA_RESULT((short) 0x107), // FF
	AVATAR_MEGA((short) 0x108), // 100
	AVATAR_MEGA_REMOVE((short) 0x109), // 101
	POPUP2((short) 0x9D), CANCEL_NAME_CHANGE((short) 0x9E), CANCEL_WORLD_TRANSFER((short) 0x9F), CLOSE_HIRED_MERCHANT(
			(short) 0xA3), // A0
			...
			MULTICHAT((short) 0x134), // 118 <-- need to test this on v145 to
										// confirm up to map effect.
			...
			SMART_MOB_NOTICE((short) 0x158), MOVE_PLATFORM((short) 0x156), // 135
			...
			INTRUSION((short) 0x162), DIFFERENT_IP((short) 0x164), ACHIEVEMENT_RATIO((short) 0x159), // 13B
			QUICK_MOVE((short) 0x15C), // 13C
			SPAWN_OBTACLE_ATOM((short) 0x15D), SPAWN_PLAYER((short) 0x167), // 144
			REMOVE_PLAYER_FROM_MAP((short) 0x168), // 145
			CHATTEXT((short) 0x169), CHATTEXT_1((short) 0x16A), // 170
			...
			PVP_ATTACK((short) 0x140), PVP_MIST((short) 0x141), PVP_COOL((short) 0x142), TESLA_TRIANGLE((short) 0x999), // 17E
																														// need
																														// the
																														// right
																														// v145
																														// one
																														// plox..
			FOLLOW_EFFECT((short) 0x15D), SHOW_PQ_REWARD((short) 0x15F), CRAFT_EFFECT((short) 0x182), // 15F
			CRAFT_COMPLETE((short) 0x183), // 160
			HARVESTED((short) 0x185), // 161
			PLAYER_DAMAGED((short) 0x165), NETT_PYRAMID((short) 0x166), SET_PHASE((short) 0x167), PAMS_SONG(
					(short) 0x168), SPAWN_PET((short) 0x192), // +2
					...
					SHOW_MAP_NAME((short) 0x999), OPEN_BAG((short) 0x21D), // 18B
					...
					MONSTER_PROPERTIES((short) 0x1B9), REMOVE_TALK_MONSTER((short) 0x1BA), TALK_MONSTER(
							(short) 0x28A), CYGNUS_ATTACK((short) 0x28F), MONSTER_RESIST((short) 0x290), //
							MOB_REACTION((short) 0x291), MOB_TO_MOB_DAMAGE((short) 0x1C6), AZWAN_MOB_TO_MOB_DAMAGE(
									(short) 0x1C9), AZWAN_SPAWN_MONSTER((short) 0x22C), // 1CA
																						// /0x22b?
									...
									SPAWN_KITE((short) 0x2B8), DESTROY_KITE((short) 0x2B9), SPAWN_MIST((short) 0x2BA), // v145,
																														// seems
																														// right..
									REMOVE_MIST((short) 0x2BB), SPAWN_DOOR((short) 0x2BC), // v145,
																							// WRONG!
																							// 0x2B6
									REMOVE_DOOR((short) 0x2BD), BUTT_FUCKIN((short) 0x6969), MECH_DOOR_SPAWN(
											(short) 0x2BE), // v145, confirmed.
											MECH_DOOR_REMOVE((short) 0x2BF), // v145,
																				// confirmed.
											REACTOR_HIT((short) 0x2C0), // 2C0
											REACTOR_MOVE((short) 0x2C1), // 2C1
											REACTOR_SPAWN((short) 0x2C2), // v145,
																			// confirmed.
											...
											ARIANT_SCORE_UPDATE((short) 0x300), SHEEP_RANCH_INFO(
													(short) 0x301), SHEEP_RANCH_CLOTHES((short) 0x999), // 0x302
													WITCH_TOWER((short) 0x999), // 0x303
													EXPEDITION_CHALLENGE((short) 0x999), // 0x304
													ZAKUM_SHRINE((short) 0x305), CHAOS_ZAKUM_SHRINE(
															(short) 0x306), PVP_TYPE((short) 0x307), PVP_TRANSFORM(
																	(short) 0x308), PVP_DETAILS(
																			(short) 0x309), PVP_ENABLED(
																					(short) 0x30A), PVP_SCORE(
																							(short) 0x30B), PVP_RESULT(
																									(short) 0x30C), PVP_TEAM(
																											(short) 0x30D), PVP_SCOREBOARD(
																													(short) 0x30E), PVP_POINTS(
																															(short) 0x310), PVP_KILLED(
																																	(short) 0x311), PVP_MODE(
																																			(short) 0x312), PVP_ICEKNIGHT(
																																					(short) 0x313), //
																																					HORNTAIL_SHRINE(
																																							(short) 0x2E1), CAPTURE_FLAGS(
																																									(short) 0x2E2), CAPTURE_POSITION(
																																											(short) 0x2E3), CAPTURE_RESET(
																																													(short) 0x2E4), PINK_ZAKUM_SHRINE(
																																															(short) 0x2E5), NPC_TALK(
																																																	(short) 0x33D), // 0x2E6
																																																	OPEN_NPC_SHOP(
																																																			(short) 0x33E), // 2E7
																																																											...
																																																											RPS_GAME(
																																																													...
																																																													MESSENGER(
																																																															...
																																																															PLAYER_INTERACTION(
																																																																	(short) 0x34F), // 2F6
																																																																	VICIOUS_HAMMER(
																																																																			(short) 0x2F4), LOGOUT_GIFT(
																																																																					(short) 0x2FB), TOURNAMENT(
																																																																							(short) 0x236), TOURNAMENT_MATCH_TABLE(
																																																																									(short) 0x237), TOURNAMENT_SET_PRIZE(
																																																																											(short) 0x238), TOURNAMENT_UEW(
																																																																													(short) 0x239), TOURNAMENT_CHARACTERS(
																																																																															(short) 0x23A), SEALED_BOX(
																																																																																	(short) 0x23C), WEDDING_PROGRESS(
																																																																																			(short) 0x236), WEDDING_CEREMONY_END(
																																																																																					(short) 0x237), PACKAGE_OPERATION(
																																																																																							(short) 0x353), // v143
																																																																																							CS_CHARGE_CASH(
																																																																																									(short) 0x2CA), CS_EXP_PURCHASE(
																																																																																											(short) 0x23B), GIFT_RESULT(
																																																																																													(short) 0x23C), CHANGE_NAME_CHECK(
																																																																																															(short) 0x23D), CHANGE_NAME_RESPONSE(
																																																																																																	(short) 0x23E), CS_UPDATE(
																																																																																																			(short) 0x35B), // 355
																																																																																																			CS_OPERATION(
																																																																																																					(short) 0x35C), // 356
																																																																																																					CS_MESO_UPDATE(
	...
	GACHAPON_STAMPS((short) 0x253), FREE_CASH_ITEM((short) 0x254), CS_SURPRISE((short) 0x255), XMAS_SURPRISE(
			(short) 0x256), ONE_A_DAY((short) 0x258), NX_SPEND_GIFT((short) 0x25A), RECEIVE_GIFT((short) 0x25A), // new
																													// v145
			KEYMAP((short) 0x37C), // 320
			PET_AUTO_HP((short) 0x377), // 321
			PET_AUTO_MP((short) 0x378), // 322
			PET_AUTO_CURE((short) 0x379), // 323
			START_TV((short) 0x324), REMOVE_TV((short) 0x325), ENABLE_TV((short) 0x326), GM_ERROR(
					(short) 0x26D), ALIEN_SOCKET_CREATOR((short) 0x341), GOLDEN_HAMMER(
							(short) 0x279), BATTLE_RECORD_DAMAGE_INFO((short) 0x27A), CALCULATE_REQUEST_RESULT(
									(short) 0x27B), BOOSTER_PACK((short) 0x999), BOOSTER_FAMILIAR(
											(short) 0x999), BLOCK_PORTAL((short) 0x999), NPC_CONFIRM(
													(short) 0x999), RSA_KEY((short) 0x999), LOGIN_AUTH(
															(short) 0x999), PET_FLAG_CHANGE((short) 0x999), BUFF_BAR(
																	(short) 0x999), GAME_POLL_REPLY(
																			(short) 0x999), GAME_POLL_QUESTION(
																					(short) 0x999), ENGLISH_QUIZ(
																							(short) 0x999), FISHING_BOARD_UPDATE(
																									(short) 0x999), BOAT_EFFECT(
																											(short) 0x999), FISHING_CAUGHT(
																													(short) 0x999), SIDEKICK_OPERATION(
																															(short) 0x999), FARM_PACKET1(
																																	(short) 0x35C), FARM_ITEM_PURCHASED(
																																			(short) 0x35D), FARM_ITEM_GAIN(
																																					(short) 0x358), HARVEST_WARU(
																																							(short) 0x35A), FARM_MONSTER_GAIN(
																																									(short) 0x35B), FARM_INFO(
																																											(short) 0x368), FARM_MONSTER_INFO(
																																													(short) 0x369), FARM_QUEST_DATA(
																																															(short) 0x36A), FARM_QUEST_INFO(
																																																	(short) 0x36B), FARM_MESSAGE(
																																																			(short) 0x36C), // 36C
																																																			UPDATE_MONSTER(
																																																					(short) 0x36D), AESTHETIC_POINT(
																																																							(short) 0x36E), UPDATE_WARU(
																																																									(short) 0x36F), FARM_EXP(
																																																											(short) 0x374), FARM_PACKET4(
																																																													(short) 0x375), QUEST_ALERT(
																																																															(short) 0x377), FARM_PACKET8(
																																																																	(short) 0x378), FARM_FRIENDS_BUDDY_REQUEST(
																																																																			(short) 0x37B), FARM_FRIENDS(
																																																																					(short) 0x37C), FARM_USER_INFO(
																																																																							(short) 0x388), FARM_AVATAR(
																																																																									(short) 0x38A), FRIEND_INFO(
																																																																											(short) 0x38D), FARM_RANKING(
																																																																													(short) 0x38F), // +69
																																																																													SPAWN_FARM_MONSTER1(
																																																																															(short) 0x393), SPAWN_FARM_MONSTER2(
																																																																																	(short) 0x394), RENAME_MONSTER(
																																																																																			(short) 0x395), STRENGTHEN_UI(
																																																																																					(short) 0x408), // 39D
	// Unplaced:
	...
	public short getValue(boolean show) {
		if (show && ServerConfig.logPackets && !isSpamHeader(this)) {
			...
			System.out.println("[Send]\t" + this.name() + tab + "|\t" + this.code + "\t|\t" + HexTool.getOpcodeToString(
					this.code)/*
								 * + "\r\nCaller: " +
								 * Thread.currentThread().getStackTrace()[2]
								 */);
			FileoutputUtil.log("PacketLog.txt", "\r\n\r\n[Send]\t" + this.name() + tab + "|\t" + this.code + "\t|\t"
					+ HexTool.getOpcodeToString(this.code) + "\r\n\r\n");
		}
		return code;
	}
