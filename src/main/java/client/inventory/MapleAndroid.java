...
public class MapleAndroid implements Serializable {
	...
	public final void saveToDb() {
		...
		try {
			try (PreparedStatement ps = DatabaseConnection.getConnection()
					.prepareStatement("UPDATE androids SET hair = ?, face = ?, name = ? WHERE uniqueid = ?")) {
	...
	public static final MapleAndroid create(int itemid, int uniqueid, int hair, int face) {
		...
		try {
			...
			try (PreparedStatement pse = DatabaseConnection.getConnection()
					.prepareStatement("INSERT INTO androids (uniqueid, hair, face, name) VALUES (?, ?, ?, ?)")) {
