...
public class FarmOperation {
	...
	public static void EnterFarm(final CharacterTransfer transfer, final MapleClient c) {
		...
		// c.getSession().write(CField.getPacketFromHexString("19 72 1E 02 00 00
		// 00 00 00 00 00 00 00 00 00 00 0B 00 43 72 65 61 74 69 6E 67 2E 2E 2E
		// 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00 00
		// 00 00 00 00 00 00 01 00 00 00 00 0B 00 43 72 65 61 74 69 6E 67 2E 2E
		// 2E 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 02 00
		// 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 FF FF FF FF 00"));
		...
		if (c.getFarm().getName().equals("Creating...")) { // todo put it on
															// farm update
															// handler
