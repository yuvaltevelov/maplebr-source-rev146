...
public class BuffInformation {
	...
	public static void dumpSkills() {
						...
						for (MapleData sub4 : sub3.getChildren()) {
							...
							try {
								if (sub4.getData() instanceof String || sub4.getData() instanceof Integer) {
									...
									// info =
									// MapleDataTool.getImage(sub4).toString();
									info = "image";
								}
		...
		System.out.println("Total time: " + minutes + " minute(s), " + seconds + " second(s), " + milliseconds
				+ " millisecond(s).");
	}
	...
	public static String[] opt = { "icon", "iconMouseOver", "iconDisabled", "invisible", "level", "effect", "affected",
			"info", "common", "disable", "action", "hit", "screen", "repeat", "effect0", "timeLimited", "notExtend",
			"special", "mobCode", "psd", "cDoor", "mDoor", "Frame", "PVPcommon", "elemAttr", "tile", "mob", "ball",
			"finalAttack", "summon", "masterLevel", "notRemoved", "affected0", "mob0", "skillTamingMob", "weather",
			"disableNextLevelInfo", "?????", "CharLevel", "req", "effect1", "effect2", "addAttack", "skillType",
			"weapon", "weapon2", "effect_1H", "state", "finish", "standBuffOn", "combatOrders", "specialActionFrame",
			"hyper", "reqLev", "psdSkill", "targetPlus", "prepare", "prepare_1H", "keydown", "keydown_1H", "gaugemax",
			"gaugemax_1H", "attected", "afterimage", "special0", "effect3", "info2", "keydownend", "prepare0",
			"keydown0", "damage", "effectR", "pvpCommon", "number", "icon1", "icon2", "icon3", "icon4", "icon5",
			"effect4", "specialAffected", "subWeapon", "repeat2", "tile0", "keydownloop", "exceedInfo", "weapon ",
			"finish0", "back_effect0", "back_effect", "back", "back_finish", "sDoor", "oDoor", "eDoor", "ball0",
			"edgeEffect", "anotherModeInfo", "keydownend0", "mob1", "mob2", "fixLevel", "skillpet", "skillDelay",
			"icon6", "skillpetAction", "specialPre", "specialLoop", "specialEnd", "specialLoop0", "special1", "loop",
			"end", "screen0", "PVP", "specialAction", "type", "monkeyAction", "mob3", "mob4", "specialAffcted", "hit0",
			"hit1", "effect_ship", "normalGauge", "commandGauge", "effectCash1_", "effectCash1_1", "effectCash2_",
			"effectCash2_1", "effectCash3_", "effectCash3_1", "vehicleID", "reduceMoveTime", "setItemReason",
			"setItemPartsCount", "1", "petPassive", "maxLevel", "1932014", "pvp", "chainAttack" };
}
