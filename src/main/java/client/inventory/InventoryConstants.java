...
public class InventoryConstants {
	...
	public static final short CASH_SHIELD = -10;
	...
	public static boolean idMatchesSlot(int itemid, short slot) {
		return ((slot != -11) || (isWeapon(itemid))) && ((slot != -18) || (isMount(itemid)))
				&& ((slot != -6) || (isBottom(itemid)))
				&& ((slot != -10) || (isShield(itemid)) || (itemid / 10000 == 135))
				&& ((slot != -49) || (itemid / 10000 == 114)) && ((slot != -7) || (isShoe(itemid)))
				&& ((slot != -5) || (isTop(itemid)) || (isOverall(itemid))) && ((slot != -4) || (isEarring(itemid)))
				&& ((slot != -1) || (isHat(itemid))) && ((slot != -8) || (isGlove(itemid)))
				&& ((slot != -9) || (isCape(itemid))) && ((slot != -13) || (isFaceAccessory(itemid)))
				&& ((slot == -12) || (slot == -13) || (slot == -14) || (slot == -15) || (slot == -112) || (slot == -113)
						|| (slot == -114) || (slot == -115))
				&& (isRing(itemid)) && ((slot != -19) || (isSaddle(itemid)))
				&& ((slot != -17) || (isNeckAccessory(itemid))) && ((slot != -50) || (isBelt(itemid)))
				&& ((slot == -123) || (slot == -124) || (slot == -125)) && (isPetEquip(itemid))
	...
	public static boolean isArmor(int itemid) {
		return (isTop(itemid)) || (isBottom(itemid)) || (isOverall(itemid)) || (isHat(itemid)) || (isGlove(itemid))
				|| (isShoe(itemid)) || (isCape(itemid));
	}

	public static boolean isAccessory(int id) {
		return (isFaceAccessory(id)) || (isNeckAccessory(id)) || (isEarring(id)) || (isEyeAccessory(id)) || (isBelt(id))
				|| (isMedal(id));
	}
