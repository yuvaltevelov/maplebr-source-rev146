...
public class ServerConfig {
	...
	public static boolean logAccounts = false; // Writes to a loose file called
												// Account, unhashed.
	public static boolean DISABLE_PIC = false;
	public static final int flags = 3;
	public static final String serverName = "Ethereal";
	...
	public static final int HOME_MAP_ID = 910000000; // xenon lab (mob version),
														// map used for @home
	...
	public static enum Events {
		...
		EVENT2("PVP"), 
			VENT3("CygnusBattle"), EVENT4("ScarTarBattle"), EVENT5(
				"BossBalrog_EASY"), EVENT6("BossBalrog_NORMAL"), EVENT7("HorntailBattle"), EVENT8("Nibergen"), EVENT9(
						"PinkBeanBattle"), EVENT10("ZakumBattle"), EVENT11("NamelessMagicMonster"), EVENT12(
								"Dunas"), EVENT13("Dunas2"), EVENT14("2095_tokyo"), EVENT15("ZakumPQ"), EVENT16(
										"LudiPQ"), EVENT17("KerningPQ"), EVENT18("ProtectTylus"), EVENT19(
												"WitchTower_EASY"), EVENT20("WitchTower_Med"), EVENT21(
														"WitchTower_Hard"), EVENT22("Vergamot"), EVENT23(
																"ChaosHorntail"), EVENT24("ChaosZakum"), EVENT25(
																		"CoreBlaze"), EVENT26("BossQuestEASY"), EVENT27(
																				"BossQuestMed"), EVENT28(
																						"BossQuestHARD"), EVENT29(
																								"BossQuestHELL"), EVENT30(
																										"Ravana_EASY"), EVENT31(
																												"Ravana_HARD"), EVENT32(
																														"Ravana_MED"), EVENT33(
																																"GuildQuest"), EVENT34(
																																		"Aufhaven"), EVENT35(
																																				"Dragonica"), EVENT36(
																																						"Rex"), EVENT37(
																																								"MonsterPark"), EVENT38(
																																										"KentaPQ"), EVENT39(
																																												"ArkariumBattle"), EVENT40(
																																														"AswanOffSeason"), EVENT41(
																																																"HillaBattle"), EVENT42(
																																																		"The Dragon Shout"), EVENT43(
																																																				"VonLeonBattle"), EVENT44(
																																																						"Ghost"), EVENT45(
																																																								"OrbisPQ"), EVENT46(
																																																										"Romeo"), EVENT47(
																																																												"Juliet"), EVENT48(
																																																																																						...
																																																																																						"Boats"), EVENT61(
																																																																																								"Flight"), EVENT62(
																																																																																										"Visitor"), EVENT63(
																																																																																												"AirPlane"), EVENT64(
																																																																																														"Ghost"), EVENT65(
																																																																																																"PinkBeanBattle"), EVENT66(
																																																																																																		"Aswan"), EVENT67(
																																																																																																				"AswanOffSeason"), EVENT68(
																																																																																																						"Subway"), EVENT69(
																																																																																																								"PierreBattle"), EVENT70(
																																																																																																										"PierreEasy"), EVENT71(
																																																																																																												"QueenBattle"), EVENT72(
																																																																																																														"QueenEasy"), EVENT73(
																																																																																																																"VellumBattle"), EVENT74(
																																																																																																																		"VellumEasy"), EVENT75(
																																																																																																																				"VonBonBattle"), EVENT76(
																																																																																																																						"VonBonEasy"), EVENT77(
																																																																																																																								"EasyMagnus"), EVENT78(
																																																																																																																										"MagnusBattle");
