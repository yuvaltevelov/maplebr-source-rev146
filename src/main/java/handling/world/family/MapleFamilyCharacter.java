...
public class MapleFamilyCharacter implements java.io.Serializable {
	...
	public List<MapleFamilyCharacter> getAllJuniors(MapleFamily fam) { // to be
																		// used
																		// scarcely
	...
	public List<MapleFamilyCharacter> getOnlineJuniors(MapleFamily fam) { // to
																			// be
																			// used
																			// scarcely
		List<MapleFamilyCharacter> ret = new ArrayList<>();
	...
	public int resetDescendants(MapleFamily fam) { // advisable to only start
													// this with leader. resets
													// EVERYONE
		// recursion.
		descendants = 0;
		if (junior1 > 0) {
