...
public class ZeroBuff extends AbstractBuffClass {
	...
	public void handleBuff(MapleStatEffect eff, int skill) {
		...
		// there should not be any impact (i.e., it will keep its
		// functionality).
		...
		case 100001263: // Divine Force
			...
			eff.statups.put(MapleBuffStat.STATUS_RESIST_TWO, eff.info.get(MapleStatInfo.indieTerR));// 0x10,
																									// 9
			eff.statups.put(MapleBuffStat.ELEMENT_RESIST, eff.info.get(MapleStatInfo.indieAsrR));// 0x20,
																									// 9
			eff.statups.put(MapleBuffStat.WDEF_BOOST2, eff.info.get(MapleStatInfo.indiePdd)); // 0x2000,
																								// 6
			eff.statups.put(MapleBuffStat.MDEF_BOOST2, eff.info.get(MapleStatInfo.indieMdd)); // 0x4000,
																								// 6
			eff.statups.put(MapleBuffStat.INDIE_PAD, eff.info.get(MapleStatInfo.indieMad)); // 0x400,
																							// 5
			eff.statups.put(MapleBuffStat.INDIE_MAD, eff.info.get(MapleStatInfo.indiePad)); // 0x800,
																							// 5
			break;
