...
public enum MapleFamilyBuff {
	...
	Teleport("Family Reunion", "[Target] Me\n[Effect] Teleport directly to the Family member of your choice.", 0, 0, 0,
			300, 190000), Summon("Summon Family",
					"[Target] 1 Family member\n[Effect] Summon a Family member of choice to the map you're in.", 1, 0,
					0, 500, 190001), Drop_12_15("My Drop Rate 1.2x (15min)",
							"[Target] Me\n[Time] 15 min.\n[Effect] Monster drop rate will be increased #c1.2x#.\n*  If the event is in progress, this will be nullified.",
							2, 15, 120, 700, 190002), EXP_12_15("My EXP Rate 1.2x (15min)",
									"[Target] Me\n[Time] 15 min.\n[Effect] Monster EXP rate will be increased #c1.2x#.\n*  If the event is in progress, this will be nullified.",
									3, 15, 120, 800, 190003), Drop_12_30("My Drop Rate 1.2x (30min)",
											"[Target] Me\n[Time] 30 min.\n[Effect] Monster drop rate will be increased #c1.2x#.\n*  If the event is in progress, this will be nullified.",
											2, 30, 120, 1000, 190004),
											// EXP_12_30("My EXP Rate 1.2x
											// (30min)", "[Target] Me\n[Time] 30
											// min.\n[Effect] Monster EXP rate
											// will be increased #c1.2x#.\n* If
											// the event is in progress, this
											// will be nullified.", 3, 30, 120,
											// 1200, 190005),
											Drop_15_15("My Drop Rate 1.5x (15min)",
													"[Target] Me\n[Time] 15 min.\n[Effect] Monster drop rate will be increased #c1.5x#.\n*  If the event is in progress, this will be nullified.",
													2, 15, 150, 1500, 190009),
													// Drop_15_30("My Drop Rate
													// 1.5x (30min)", "[Target]
													// Me\n[Time] 30
													// min.\n[Effect] Monster
													// drop rate will be
													...
													// this will be nullified.",
													// 2, 30, 150, 2000,
													// 190010),
													Bonding("Family Bonding (30min)",
															...
															4, 30, 150, 3000, 190006);
	// Drop_Party_12("My Party Drop Rate 1.2x (30min)", "[Target] Party\n[Time]
	// 30 min.\n[Effect] Monster drop rate will be increased #c1.2x#.\n* If the
	// event is in progress, this will be nullified.", 2, 30, 120, 4000,
	// 190007),
	// EXP_Party("My Party EXP Rate 1.2x (30min)", "[Target] Party\n[Time] 30
	// min.\n[Effect] Monster EXP rate will be increased #c1.2x#.\n* If the
	// event is in progress, this will be nullified.", 3, 30, 120, 5000,
	// 190008),
	// Drop_Party_15("My Party Drop Rate 1.5x (30min)", "[Target] Party\n[Time]
	// 30 min.\n[Effect] Monster drop rate will be increased #c1.5x#.\n* If the
	// event is in progress, this will be nullified.", 2, 30, 150, 7000,
	// 190011);
