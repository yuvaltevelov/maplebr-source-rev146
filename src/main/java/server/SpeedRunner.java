...
public class SpeedRunner {
	...
	private static final Map<ExpeditionType, Triple<String, Map<Integer, String>, Long>> speedRunData = new EnumMap<>(
	...
	public final static Pair<StringBuilder, Map<Integer, String>> addSpeedRunData(StringBuilder ret,
		...
		rettt.append("#bThese are the squad members of ").append(leader).append("'s squad at rank ").append(rank)
				.append(".#k\r\n\r\n");
